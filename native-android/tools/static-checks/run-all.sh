...
#
# این‌ها **جایگزینِ کامپایلر نیستن** - فقط پنج کلاس خطا رو می‌گیرن که تجربه نشون داده تو
...
#
# بندهای ۴ و ۵ بعدِ شکستِ بیلدِ ۴۶۵ اضافه شدن - هر دو خطایی که بررسیِ ایمپورت‌محور نمی‌گرفت.
#
