 ...
 * به همون خاکستریِ AppMuted قبلی برگشت. [backgroundColor] برای مواردی که کارت واقعاً باید رنگ زمینه‌ی
 * خاص خودش داشته باشه override می‌شه - با احتیاط استفاده کن: یه رنگِ نیمه‌شفاف رو این `Surface` (که
 * خودش tonalElevation داره) راحت دوتُنی/کثیف به‌نظر می‌رسه؛ کارتِ تحلیلِ درآمد تو MyLoansScreen قبلاً
 * دقیقاً همین مشکل رو داشت و به پیش‌فرضِ بدون override برگشت. */
@Composable
fun AppCard(
