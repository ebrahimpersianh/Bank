...
val SHOP_CATALOG: List<ShopItem> = buildList {
    ...
    // طرحِ تازه‌ی کاربر (۳۱ شهریور) - هشت پله‌ی پژمردگی‌اش را خودِ فایلِ هنری داشت.
    add(ShopItem("icon:emblem", CoinSpend.APP_ICON, "نشانِ رشد", "سبز و طلا، نمودارِ رو‌به‌بالا"))
