...
data class InboxMessageEntity(
    ...
    /**
     * **از کجا آمده** - یک خطِ کوتاهِ خواندنی که زیرِ کارت چاپ می‌شود، مثلاً
     * «پیامک از ۱۰۰۰۱۰۱۰» یا «اعلانِ بلوبانک».
     *
     * بی این، کاربر کارتی می‌بیند که نمی‌داند از کجا آمده و نمی‌تواند اشتباهِ تشخیص را
     * ردیابی کند - همان چیزی که با یک برداشتِ ساختگیِ «قبض» گزارش شد.
     */
    val sourceLabel: String? = null,
    /**
     * **متنِ خامِ همان پیامک/اعلان.** کارت با لمس این را نشان می‌دهد، پس کاربر دقیقاً می‌بیند
     * چه متنی به این تراکنش تعبیر شده. تنها راهِ واقعیِ فهمیدنِ تشخیصِ غلط.
     */
