...
data class AccountTransactionEntity(
    ...
    /**
     * منبعِ ثبت، برای نمایش در خطِ دومِ ردیف (فریمِ `71a`): «اعلانِ بلوبانک»، «پیامکِ ۲۰۰۰۱۵»…
     *
     * ⚠️ `null` یعنی **دستی** و همان‌طور هم نوشته می‌شود، نه با خطِ خالی (قاعده‌ی ۳ِ `71c`:
     * خطِ خالی یعنی «نمی‌دانم»). تا پیش از این، برچسبِ برنامه فقط در مرکزِ پیام‌ها می‌نشست و
