...
- ⏳ بقیه‌ی موارد (بازطراحی تنظیمات به‌صورت پنل روی صفحه، انیمیشن خوش‌آمدگویی، قفل امنیتی
  PIN+اثر انگشت [برگردوندن تصمیم قبلی حذف بایومتریک]، فیلتر/مرتب‌سازی وام‌های من، داشبورد اصلی با
  تحلیل درآمد، جدول اقساط صفحه‌بندی‌شده، بخش آمار+PDF، تقویم مالی) هنوز کار می‌کنه - هرکدوم با CI
  جدا تایید و merge می‌شن.
