...
- ✅ **گیت ورود اجباری + حالت مهمان** (`ui/auth/`) — `AuthViewModel`/`LoginScreen` پورت
  ...
  از اپ نیست)، و محدودیت «۱ وام رایگان»/اشتراک که به همین گیت وصله.
- ⏳ ویرایش دستی مبلغ هر قسط، مدل کامل پرداخت مستقل هر قسط (با تاریخ/تاخیر)، فرم تاریخ شروع وام
  دستی، محدودیت «۱ وام رایگان»/اشتراک، تنظیمات (و خروج از حساب)، سینک ابری واقعی، اشتراک
  کافه‌بازار، قفل اثر انگشت، و تم روشن هنوز پورت نشدن (فاز بعد).
