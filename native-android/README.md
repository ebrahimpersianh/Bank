...
- ⏳ بقیه‌ی موارد (بازطراحی تنظیمات به‌صورت پنل روی صفحه، قفل امنیتی PIN+اثر انگشت [برگردوندن
  تصمیم قبلی حذف بایومتریک]، داشبورد اصلی با تحلیل درآمد، بخش آمار+PDF، تقویم مالی) هنوز کار
  می‌کنه - هرکدوم با CI جدا تایید و merge می‌شن.
