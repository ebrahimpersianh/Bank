...
import ir.sadteam.loancalc.server.trialEndsAtMs
...
@Serializable
private data class VerifyOtpResponse(val token: String, val phone: String, val subscribed: Boolean, val trialEndsAt: Long?)

@Serializable
private data class MeResponse(val phone: String, val subscribed: Boolean, val subscribedUntil: String?, val trialEndsAt: Long?)
